    ...
    <section className="automation-page">
      ...
      >
        <Dialog.Portal>
          ...
          <Dialog.Content
            className="connection-dialog automation-editor automation-task-dialog"
                    ...
                    <div className="automation-form automation-grid">
                      ...
                      <label>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            policy({
                              action: e.target.value as Policy["action"],
                            })
                          }
                        >
